...
def model_opts(parser):
    ...
    group.add_argument('-edim', type=int, default=920)
    group.add_argument('-hdim', type=int, default=920)
    group.add_argument('-odim', type=int, default=50)
    group.add_argument('-dropout', type=float, default=0.4)
    # group.add_argument('-dropout', type=float, default=0.6)
...
def train_opts(parser):
    ...
    #                    default=os.path.join(AGREE,
    #                                         'numpred.val'))
    group.add_argument('-fload', type=str, default='agreement-overall-lstm-1537976153.model')
