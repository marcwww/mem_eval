...
def model_opts(parser):
    ...
    group.add_argument('-stack_depth', type=int, default=3)
    ...
    group.add_argument('-N', type=int, default=200)
...
def train_opts(parser):
    ...
    group.add_argument('-ftrain', type=str,
                       default=os.path.join(FLANG,
                        'expr-num10000-dbound3-ebound1.train.txt'))
    group.add_argument('-fvalid', type=str,
                       default=os.path.join(FLANG,
                        'expr-num1000-dbound7-ebound1.valid.txt'))
